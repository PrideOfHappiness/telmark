                        ...
                        <div class="card card-flush h-lg-100" id="kt_contacts_main">
                            ...
                            <div class="card-header pt-7" id="kt_chat_contacts_header">
                                ...
                                <div class="card-title">
                                    ...
                                    <h2>&nbsp Tambah Data Tentang Kami</h2>
                                </div>
                                <!--end::Card title-->
                            </div>
                            ...
                            <div class="card-body pt-5">
                                <!--begin::Form-->
                                <form id="kt_ecommerce_settings_general_form" class="form" action="{{ route('aboutUs.store') }}" method="post">
                                    @csrf
                                    <!--begin::Input group-->
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <select id="status" class="form-select form-select-solid" name="jenis" data-placeholder="Silahkan pilih status lokasi">
                                                <option>Silahkan pilih lokasi terlebih dahulu!</option>
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid" name="judul" value="" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <textarea class="form-control form-control-solid" name="data"></textarea>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Row-->
