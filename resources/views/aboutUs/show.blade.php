...
<head>
    <title>Detail Tentang Kami</title>
    <meta charset="utf-8" />
                            ...
                            <div class="card-body pt-5">
                                ...
                                <form id="kt_ecommerce_settings_general_form" class="form" action="{{ route('aboutUs.store') }}" method="post">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="w-100">
                                            <!--begin::Select2-->
                                            <input type="text" class="form-control form-control-solid" name="judul" value="{{ $jenis }}" readonly/>
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid" name="judul" value="{{ $data->judul }}" readonly/>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <textarea class="form-control form-control-solid" name="data" readonly>"{{ $data->data }}"</textarea>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Row-->
