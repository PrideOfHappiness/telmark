...
<style>
    body {
        background-image: url('{{ asset('metronic/assets/media/auth/bg10.jpg') }}');
    }

    [data-bs-theme="dark"] body {
        background-image: url('{{ asset('metronic/assets/media/auth/bg10-dark.jpg') }}');
    }
</style>
<!--end::Page bg image-->
...
<div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    <div class="d-flex flex-lg-row-fluid">
        ...
        <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100"> 
            <!--begin::Image-->                
            <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="{{ asset('metronic/assets/media/auth/logo-smallx2.png')}}" alt=""/>    
...
<form class="form w-100" action="{{ route('login')}}" method="POST">
    ...
    <div class="text-center mb-11">
        ...
        <div class="text-gray-500 fw-semibold fs-6">
            Silahkan masuk untuk memulai sesi administrasi anda disini!
        </div>
        <!--end::Subtitle--->
    </div>
    <!--begin::Heading-->
    ...
    <div class="row g-3 mb-9">
        ...
        <div class="col-md-6">
            ...
            <a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                <img alt="Logo" src="{{ asset('metronic/assets/media/svg/brand-logos/google-icon.svg')}}" class="h-15px me-3"/>   
                Sign in with Google
            </a>
            <!--end::Google link--->
        </div>
        ...
        <div class="col-md-6">
            ...
            <a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                ...
                <img alt="Logo" src="{{ asset('metronic/assets/media/svg/brand-logos/apple-black-dark.svg')}}" class="theme-dark-show h-15px me-3"/>     
                Sign in with Apple
            </a>
            <!--end::Google link--->
        </div>
...
<!--end::Form-->     
                ...
                <div class=" d-flex flex-stack">
                    ...
                    <div class="d-flex fw-semibold text-primary fs-base gap-5">
                        <a href="{{ asset('metronic/pages/team.html')}}" target="_blank">Terms</a>

                        <a href="{{ asset('metronic/pages/pricing/column.html')}}" target="_blank">Plans</a>
                        
                        <a href="{{ asset('metronic/pages/contact.html')}}" target="_blank">Contact Us</a>
                    </div>
                    <!--end::Links-->
                </div>
                <!--end::Footer-->
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/authentication/layouts/overlay/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jan 2024 13:13:55 GMT -->
</html>