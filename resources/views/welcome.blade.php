...
<div class="menu-active-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
    ...
    <div class="row">
        ...
        <div class="col-lg-5 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center">
            <img src="{{ asset('metronic/assets/media/stock/900x600/45.jpg')}}" class="rounded mw-100" alt=""/>
        </div>
        <!--end:Col-->
    </div>
    <!--end:Row-->
        ...
        <a href="#" class="menu-link px-5">
            <span class="menu-title position-relative">
                ...
                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    English <img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('metronic/assets/media/flags/united-states.svg')}}" alt=""/>
                </span>
            </span>
        </a>
...
style="background-color: #F1416C;background-image:url('{{ asset('metronic/assets/media/patterns/vector-1.png')}}')">
    <!--begin::Header-->
...
<div class="card card-flush h-md-100"> 
    ...
    style="background-position: 100% 50%; background-image:url('{{ asset('metronic/assets/media/stock/900x600/42.png')}}')">     
        <!--begin::Wrapper--> 
        <div class="mb-10">
            <!--begin::Title-->      
        ...
        <div class="row gx-9 h-100">
            ...
            <div class="col-sm-6 mb-10 mb-sm-0">
                ...
                <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100" 
                    style="background-size: 100% 100%;background-image:url('{{ asset('metronic/assets/media/stock/600x600/img-65.jpg')}}')">              
                </div> 
                <!--end::Image-->
            </div>
            <!--end::Col-->  
...
<div 
    ...
    style="background-image:url('{{ asset('metronic/assets/media/misc/layout/customizer-header-bg.jpg')}}')">
	...
	<div class="row " data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					...
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ asset('metronic/assets/media/preview/demos/demo1/light-ltr.png')}}" class="form-check-rounded mw-100" alt=""/>                      
					</div>
					<!--end::Image--> 
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					<!--begin::Image--> 
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ asset('metronic/assets/media/preview/demos/demo1/dark-ltr.png')}}" class="form-check-rounded mw-100" alt=""/>                      
					</div>
					<!--end::Image--> 
	...
	<div class="row gy-3" data-kt-buttons="true" data-kt-buttons-target=".form-check-image:not(.disabled),.form-check-input:not([disabled])">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success active  active"  >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ asset('metronic/assets/media/misc/layout/dark-sidebar.png')}}" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success   "  >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ asset('metronic/assets/media/misc/layout/light-sidebar.png')}}" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success   "  >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ asset('metronic/assets/media/misc/layout/dark-header.png')}}" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success   "  >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ asset('metronic/assets/media/misc/layout/light-header.png')}}" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
...
<!--end::Menu 3-->
    ...
    <div class="d-flex justify-content-start mb-10 " >
        ...
        <div class="d-flex flex-column align-items-start">
            <!--begin::User-->
            <div class="d-flex align-items-center mb-2">
                                    <!--begin::Avatar--><div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="{{ asset('metronic/assets/media/avatars/300-25.jpg')}}"/></div><!--end::Avatar-->
                    <!--begin::Details-->
                    <div class="ms-3">
    ...
    <div class="d-flex justify-content-end mb-10 " >
        ...
        <div class="d-flex flex-column align-items-end">
            ...
            <div class="d-flex align-items-center mb-2">
                    ...
                    <!--begin::Avatar--><div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="{{ asset('metronic/assets/media/avatars/300-1.jpg')}}"/></div><!--end::Avatar-->                 
            </div>
            <!--end::User-->
...
<!--end::Modal - Invite Friend-->            <!--end::Modals-->
        ...
        <!--begin::Javascript-->
        <script>
            var hostUrl = "{{ asset('metronic/assets/index.html";        </script>
