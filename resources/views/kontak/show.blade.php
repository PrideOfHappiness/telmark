...
<head>
    <title>Detail Lokasi Cabang</title>
    <meta charset="utf-8" />
                        ...
                        <div class="card card-flush h-lg-100" id="kt_contacts_main">
                            ...
                            <div class="card-header pt-7" id="kt_chat_contacts_header">
                                ...
                                <div class="card-title">
                                    ...
                                    <h2>&nbsp Data Lokasi {{ $data->namaCabang }}</h2>
                                </div>
                                <!--end::Card title-->
                            </div>
                            ...
                            <div class="card-body pt-5">
                                <!--begin::Form-->
                                <form id="kt_ecommerce_settings_general_form" class="form" action="{{ route('location.store') }}" method="post">
                                    <!--begin::Input group-->
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid" name="nama" value="{{ $data->namaCabang }}" readonly />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <textarea class="form-control form-control-solid" name="alamat" readonly>{{ $data->alamat }}</textarea>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Row-->
                                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" name="no_telp" value="{{ $data->no_telp }}" readonly />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <label class="fs-6 fw-semibold form-label mt-3">
                                            ...
                                            <span class="ms-1" data-bs-toggle="tooltip" title="Masukkan URL lokasi dari Google Maps.">
                                                <i class="fa-solid fa-circle-info"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>                    
                                            </span>
                                        </label>
                                        <br>
