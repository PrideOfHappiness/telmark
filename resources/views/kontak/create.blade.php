...
<head>
    <title>Tambah Lokasi Cabang</title>
    <meta charset="utf-8" />
                                    ...
                                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" name="no_telp" value="" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                        ...
                                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                            ...
                                            <div class="col">
                                                <div class="fv-row mb-7">
                                                    <label class="fs-6 fw-semibold form-label mt-3">
                                                        <span class="required">URL Lokasi Google Maps</span>
                                                    ...
                                                    <!--begin::Input-->
                                                    <input type="text" class="form-control form-control-solid" name="urlMaps" value="" />
                                                    <!--end::Input-->
                                                </div>
                                            </div>
                                        </div>
