...
<head>
    <title>Lokasi / Cabang Telmark</title>
    <meta charset="utf-8" />
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
    ...
    " data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
        ...
        " id="kt_app_header_menu" data-kt-menu="true">
                                ...
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2"><!--begin:Menu link--><span class="menu-link"><span class="menu-title"></span><span class="menu-arrow d-lg-none"></span></span><!--end:Menu link--><!--begin:Menu sub-->
                                </div><!--end:Menu item--><!--begin:Menu item-->
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2"><!--begin:Menu link--><span class="menu-link"><span class="menu-title"></span><span class="menu-arrow d-lg-none"></span></span><!--end:Menu link--><!--begin:Menu sub-->
                                </div><!--end:Menu item--><!--begin:Menu item-->
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2"><!--begin:Menu link--><span class="menu-link"><span class="menu-title"></span><span class="menu-arrow d-lg-none"></span></span><!--end:Menu link--><!--begin:Menu sub-->
                                </div><!--end:Menu item--><!--begin:Menu item-->
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2"><!--begin:Menu link--><span class="menu-link"><span class="menu-title"></span><span class="menu-arrow d-lg-none"></span></span><!--end:Menu link--><!--begin:Menu sub-->
                                        ...
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                <div class="fw-bold d-flex align-items-center fs-5">
                                                    {{ auth()->user()->nama }} <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2"></span>
                                                </div>
        ...
        -->
                        <div id="kt_app_sidebar_toggle" class="app-sidebar-toggle btn btn-icon btn-shadow btn-sm btn-color-muted btn-active-color-primary h-30px w-30px position-absolute top-50 start-100 translate-middle rotate " data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="app-sidebar-minimize">
                            ...
                            <i class="fa-solid fa-arrows-left-right-to-line"><span class="path1"></span><span class="path2"></span></i>
                        </div>
                        <!--end::Sidebar toggle-->
                    </div>
                    <!--end::Logo-->
                ...
                <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack ">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                                    ...
                                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                                        Data Lokasi/Cabang PT. Telmark Integrasi Indonesia
                                    </h1>
                                    <!--end::Title-->
                        ...
                        <!--begin::Content-->
                        <form action="{{ route('cariLokasi') }}" method="post">
                            @csrf
                            <!--begin::Card-->
                            <div class="card mb-7">
                                <!--begin::Card body-->
                                <div class="card-body">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-3 mb-1">Pencarian Data</span> 
                                    </h3>
                                    <!--begin::Compact form-->
                                    <div class="d-flex align-items-center">
                                        <!--begin::Input group-->
                                        <div class="position-relative w-md-400px me-md-2">
                                            <input type="text" class="form-control form-control-solid ps-10" name="search" value="" placeholder="Lokasi apa yang anda ingin cari?"/>
                                        </div>
                                        <!--end::Input group-->
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold fs-3 mb-1">Lokasi Cabang PT. Telmark Integrasi Indonesia</span>
                        
                                    <span class="text-muted mt-1 fw-semibold fs-7">Menampilkan data lokasi cabang Telmark di seluruh Indonesia.</span>
                                </h3>
                                <div class="card-toolbar">
                                    <a href="{{ route('location.create') }}" class="btn btn-sm btn-light-primary"> 
                                        <i class="fa-solid fa-plus"></i>              Lokasi belum tersedia? Tambahkan disini
                                    </a>
                                </div>
                            </div>
                            <!--end::Header-->
                                    ...
                                    <table class="table align-middle gs-0 gy-4">
                                        ...
                                        <thead>
                                            <tr class="fw-bold text-muted bg-light">
                                                <th class="ps-4 min-w-125px">Lokasi dan Alamat</th>
                                                <th class="min-w-125px">Nomor Telepon</th>
                                                <th class="min-w-125px">Alamat Email</th>
                                                <th class="min-w-150px">Status Lokasi</th>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="d-flex justify-content-start flex-column">
                                                                <a href="{{ route('location.show', $location->locationID )}}" class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">{{ $location->namaCabang }}</a>
                                                                <span class="text-muted fw-semibold text-muted d-block fs-7">Alamat: {{ $location->alamat }}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('location.show', $location->locationID )}}" class="text-gray-900 fw-bold text-hover-primary d-block mb-1 fs-6">{{ $location->email }}</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('location.show', $location->locationID )}}" class="text-gray-900 fw-bold text-hover-primary d-block mb-1 fs-6">{{ $location->no_telp }}</a>
                                                    </td>
                                                    <td>
                                                        @if($location->status == 'Cabang')
                                                            <span class="badge badge-light-success fs-7 fw-bold">Cabang</span>
                                                        @endif
                                                        @if($location->status == 'Dummy')
                                                            <span class="badge badge-light-info fs-7 fw-bold">Data Dummy</span>
                                                        @endif
                                                        @if($location->status == 'Pusat')
                                                            <span class="badge badge-light-primary fs-7 fw-bold">Pusat</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <td class="text-end">
                                                            <form action="{{ route('location.destroy', $location->locationID ) }}" method="post">
                                                                <button class="btn btn-primary"><a href="{{ route('location.show', $location->locationID) }}"><i class="fa-solid fa-eye"></i></a></button>
                                                                <button class="btn btn-success"><a href="{{ route('location.edit', $location->locationID) }}"><i class="fa-solid fa-pencil"></i></a></button>
                                                                @csrf
                                                                    @method('DELETE')
                                                                    <button class="btn btn-danger">
                                                                        <a href="{{ route('location.destroy', $location->locationID)}}">
    ...
    <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
        ...
        <div class="card shadow-none border-0 rounded-0">
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="/metronic8/demo1/../demo1/apps/projects/project.html" class="w-30px me-3" src="{{ asset('metronic/assets/media/svg/files/doc.svg')}}" />
                                            <!--end::Icon-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="/metronic8/demo1/../demo1/apps/projects/project.html" class="w-30px me-3" src="{{ asset('metronic/assets/media/svg/files/css.svg')}}" />
                                            <!--end::Icon-->
            ...
            <div class="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="{{asset('metronic/pages/user-profile/activity.html')}}" class="btn btn-bg-body text-primary">
                    ...
                    <div class="d-flex justify-content-start mb-10 ">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="{{ asset('metronic/assets/media/avatars/300-25.jpg')}}" /></div><!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10 ">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="{{ asset('metronic/assets/media/avatars/300-1.jpg')}}" /></div><!--end::Avatar-->
                            </div>
                            <!--end::User-->
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_app_engage_prebuilts_modal, #kt_app_engage_prebuilts_modal_dialog, #kt_app_engage_prebuilts_body" data-kt-scroll-dependencies="#kt_app_engage_prebuilts_header, #kt_app_engage_prebuilts_view_image_tabs" data-kt-scroll-offset="215px">
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/index.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    ...
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo1.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo2/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo2.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo39/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo39.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo31/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo31.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo9/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo9.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo38/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo38.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo30/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo30.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo6/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo6.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo60/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo60.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo8/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo8.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo62/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo62.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo58/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo58.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo56/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo56.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo34/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo34.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo27/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo27.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo29/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo29.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo57/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo57.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo3/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo3.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo36/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo36.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo20/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo20.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo59/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo59.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo55/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo55.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo51/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo51.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo10/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo10.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo61/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo61.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo52/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo52.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo63/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo63.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo40/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo40.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo23/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo23.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo64/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo64.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo35/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo35.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo33/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo33.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo19/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo19.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo25/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo25.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo50/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo50.html')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo32/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo32.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo37/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo37.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo42/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo42.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo5/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo5.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo16/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo16.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo4/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo4.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo53/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo53.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo7/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo7.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo21/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo21.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo24/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo24.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo28/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo28.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo44/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo44.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo11/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo11.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo26/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo26.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo22/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo22.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo41/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo41.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo18/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo18.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo54/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo54.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo15/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo15.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo14/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo14.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo13/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo13.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo12/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo12.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo48/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo48.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo17/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo17.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo49/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo49.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo43/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo43.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo45/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo45.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo47/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo47.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo46/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/demos/demo46.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a href="{{asset('metronic/index.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/multipurpose-demo1.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/marketing.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Marketing </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/marketing.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/social.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Social </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/social.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/ecommerce.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Ecommerce </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/ecommerce.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/store-analytics.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Store-analytics </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/store-analytics.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/logistics.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Logistics </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/logistics.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/delivery.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Delivery </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/delivery.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/online-courses.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Online-courses </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/online-courses.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/school.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        School </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/school.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/crypto.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Crypto </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/crypto.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/finance-performance.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/finance-performance.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/website-analytics.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/website-analytics.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/bidding.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Bidding </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/bidding.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/podcast.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Podcast </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/podcast.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/projects.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Projects </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/projects.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/call-center.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Call-center </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/call-center.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('metronic/dashboards/pos.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        POS </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/dashboards/pos.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/projects/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/projects.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/ecommerce/catalog/products.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/ecommerce.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/customers/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/customers.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/subscriptions/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/subscriptions.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/user-management/users/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/user-management.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/invoices/create.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/invoices.png"')}}' class=" lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/support-center/overview.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/support-center.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/chat/private.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/chat.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/calendar.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/calendar.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/file-manager/folders.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/file-manager.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/inbox/listing.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/inbox.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="apps/contacts/getting-started.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    ...
                                                    <!--begin::Thumbnail-->
                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/apps/contacts.png')}}" class="lozad w-100 rounded" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/layouts/corporate/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-corporate.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/layouts/creative/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-creative.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/layouts/fancy/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-fancy.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/layouts/overlay/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-overlay.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/extended/multi-steps-sign-up.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-multistep.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/layouts/corporate/two-factor.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-2factor.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/general/password-confirmation.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-passwordchanged.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/general/verify-email.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-verifyemail.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/general/welcome.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-welcome.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/general/coming-soon.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-comingsoon.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/general/account-deactivated.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-accountdeactivated.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/general/error-404.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-404.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/general/error-500.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/auth-500.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="show" id="kt_app_engage_prebuilts_tab_pages_general_user-profile">
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('metronic/pages/user-profile/overview.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                                        Profile Overview </h3>
                                                                    <!--end::Title-->
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/profile-overview.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('metronic/pages/user-profile/projects.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                                        User Projects </h3>
                                                                    <!--end::Title-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('metronic/pages/user-profile/campaigns.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                                        User Campaigns </h3>
                                                                    <!--end::Title-->
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/profile-campaigns.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('metronic/pages/user-profile/documents.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                                        User Documents </h3>
                                                                    <!--end::Title-->
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/profile-documents.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('metronic/pages/user-profile/followers.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                                        User Followers </h3>
                                                                    <!--end::Title-->
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/profile-followers.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('metronic/pages/user-profile/activity.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                                        User Activity </h3>
                                                                    <!--end::Title-->
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/profile-activity.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                    ...
                                                    <div class="collapse" id="kt_app_engage_prebuilts_tab_pages_general_corporate">
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('metronic/pages/about.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                                        About Us </h3>
                                                                    <!--end::Title-->
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/corporate-aboutus.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('metronic/pages/contact.html')}}" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                                        Contact Us </h3>
                                                                    <!--end::Title-->
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/corporate-contactus.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/licenses.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/corporate-license.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/team.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/corporate-ourteam.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/sitemap.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/corporate-sitemap.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/social/feeds.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/social-activity.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/social/activity.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/social-feeds.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/social/followers.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/social-followers.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/social/settings.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/social-settings.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/faq/classic.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/faq-classic.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/faq/extended.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/faq-extended.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/blog/home.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/blog-home.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="pages/blog/post.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    ...
                                                                    <!--begin::Thumbnail-->
                                                                    <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/blog-post.png')}}" class="lozad w-100 rounded" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                                <!--end::Preview-->
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="account/overview.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/account-overview.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="account/settings.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/account-settings.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="account/billing.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/account-billing.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="account/security.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/account-security.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="account/referrals.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/account-referrals.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="account/logs.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/account-logs.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="account/api-keys.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/account-apikeys.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="account/statements.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/account-statements.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/general/view-users.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-viewfriends.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/general/upgrade-plan.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-upgradeplan.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/wizards/top-up-wallet.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-topupwallet.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/general/share-earn.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-shareandearn.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/general/select-users.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-selectuser.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/forms/bidding.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-placeyourbid.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/wizards/offer-a-deal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-offeradeal.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/forms/new-target.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-newtarget.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/forms/new-card.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-newcard.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/forms/new-address.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-newaddress.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/general/invite-friends.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-invitefriend.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/wizards/create-project.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-createproject.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/wizards/create-campaign.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-createcampaign.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/wizards/create-account.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-createbusinessacc.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/wizards/create-app.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-createapp.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/forms/create-api-key.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-createapikey.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/modals/wizards/two-factor-authentication.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/modal-2factorauth.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/wizards/horizontal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/wizard-2factorauth.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/wizards/horizontal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/wizard-horizontal.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/wizards/vertical.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/wizard-vertical.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/search/users.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/search-users.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/search/horizontal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/search-horizontal.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/search/vertical.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/search-vertical.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="utilities/search/select-location.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/search-location.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="widgets/charts.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/widgets-charts.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="widgets/feeds.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/widgets-feeds.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="widgets/lists.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/widgets-lists.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="widgets/mixed.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/widgets-mixed.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="widgets/statistics.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/widgets-stats.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="widgets/tables.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/widgets-tables.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/email/welcome-message.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/email-welcome.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/email/subscription-confirmed.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/email-subscriptionconfirmed.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/email/reset-password.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/email-resetpassword.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/email/card-declined.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/email-creditcarddeclined.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/email/promo-1.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/email-promo1.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/email/promo-2.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/email-promo2.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="authentication/email/promo-3.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            ...
                                                            <!--begin::Thumbnail-->
                                                            <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('metronic/assets/media/preview/demos/placeholder.jpg')}}" data-src="{{ asset('metronic/assets/media/preview/prebuilts/pages/email-promo3.png')}}" class="lozad w-100 rounded" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                        <!--end::Preview-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/index.html')}}">
                                                    Metronic Original </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/marketing.html')}}">
                                                    Marketing Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/social.html')}}">
                                                    Social Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/ecommerce.html')}}">
                                                    eCommerce Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/store-analytics.html')}}">
                                                    Store Analytics </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/logistics.html')}}">
                                                    Logistics </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/delivery.html')}}">
                                                    Delivery </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/online-courses.html')}}">
                                                    Online Courses </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/school.html')}}">
                                                    Hello Tyler </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/crypto.html')}}">
                                                    My Balance: 37,045$ </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/finance-performance.html')}}">
                                                    Finance Performance </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/website-analytics.html')}}">
                                                    Website Analytics </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/bidding.html')}}">
                                                    Bidding Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/podcast.html')}}">
                                                    Podcast Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/projects.html')}}">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/call-center.html')}}">
                                                    Call Center </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('metronic/dashboards/pos.html')}}">
                                                    POS System </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo" src="{{ asset('metronic/assets/media/svg/brand-logos/google-icon.svg')}}" class="h-20px me-3" />
    ...
    <!--begin::Javascript-->
    <script>
        var hostUrl = "{{ asset('metronic/assets/index.html')}}";
    </script>
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jan 2024 13:09:37 GMT -->
