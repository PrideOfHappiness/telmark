            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <!--end:Menu heading-->
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="{{asset('metronic/pages/user-profile/overview.html')}}" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="{{asset('metronic/pages/user-profile/projects.html')}}" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="{{asset('metronic/pages/user-profile/campaigns.html')}}" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="{{asset('metronic/pages/user-profile/documents.html')}}" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="{{asset('metronic/pages/user-profile/followers.html')}}" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="{{asset('metronic/pages/user-profile/activity.html')}}" class="menu-link ">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/about.html')}}" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/team.html')}}" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/contact.html')}}" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/licenses.html')}}" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/sitemap.html')}}" class="menu-link ">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/careers/list.html')}}" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/careers/apply.html')}}" class="menu-link ">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0"> 
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/faq/classic.html')}}" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/faq/extended.html')}}" class="menu-link ">
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/blog/home.html')}}" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/blog/post.html')}}" class="menu-link ">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/pricing.html')}}" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/pricing/table.html')}}" class="menu-link ">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/social/feeds.html')}}" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/social/activity.html')}}" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/social/followers.html')}}" class="menu-link ">
                                <span class="menu-title">Followers</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="{{asset('metronic/pages/social/settings.html')}}" class="menu-link ">
    ...
    <div class="col-lg-3 mb-6 mb-lg-0">
        ...
        <div class="mb-6">
            ...
            <!--end:Menu heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/corporate/sign-in.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/corporate/sign-up.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/corporate/two-factor.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/corporate/reset-password.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/corporate/new-password.html')}}" class="menu-link ">
        ...
        <div class="mb-0">
            ...
            <!--end:Menu heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/overlay/sign-in.html')}}" class="menu-link ">
                        <span class="menu-title">Sign-In</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/overlay/sign-up.html')}}" class="menu-link ">
                        <span class="menu-title">Sign-Up</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/overlay/two-factor.html')}}" class="menu-link ">
                        <span class="menu-title">Two-Factor</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/overlay/reset-password.html')}}" class="menu-link ">
                        <span class="menu-title">Reset Password</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/overlay/new-password.html')}}" class="menu-link ">
                        <span class="menu-title">New Password</span>
                    </a>
                    <!--end:Menu link-->
                </div>
    ...
    <div class="col-lg-3 mb-6 mb-lg-0">
        ...
        <div class="mb-6">
            ...
            <!--end:Menu heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/creative/sign-in.html')}}" class="menu-link ">
                        <span class="menu-title">Sign-in</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/creative/sign-up.html')}}" class="menu-link ">
                        <span class="menu-title">Sign-up</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/creative/two-factor.html')}}" class="menu-link ">
                        <span class="menu-title">Two-Factor</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/creative/reset-password.html')}}" class="menu-link ">
                        <span class="menu-title">Reset Password</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/creative/new-password.html')}}" class="menu-link ">
                        <span class="menu-title">New Password</span>
                    </a>
                    <!--end:Menu link-->
                </div>
        ...
        <div class="mb-6">
            ...
            <!--end:Menu heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/fancy/sign-in.html')}}" class="menu-link ">
                        <span class="menu-title">Sign-In</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/fancy/sign-up.html')}}" class="menu-link ">
                        <span class="menu-title">Sign-Up</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/fancy/two-factor.html')}}" class="menu-link ">
                        <span class="menu-title">Two-Factor</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/fancy/reset-password.html')}}" class="menu-link ">
                        <span class="menu-title">Reset Password</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/layouts/fancy/new-password.html')}}" class="menu-link ">
                        <span class="menu-title">New Password</span>
                    </a>
                    <!--end:Menu link-->
                </div>
    ...
    <div class="col-lg-3 mb-6 mb-lg-0">
        ...
        <div class="mb-0">
            ...
            <!--end:Menu heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/extended/multi-steps-sign-up.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/general/welcome.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/general/verify-email.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/general/coming-soon.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/general/password-confirmation.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/general/account-deactivated.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/general/error-404.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/general/error-500.html')}}" class="menu-link ">
    ...
    <div class="col-lg-3 mb-6 mb-lg-0">
        ...
        <div class="mb-0">
            ...
            <!--end:Menu heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/email/welcome-message.html')}}" class="menu-link ">
                        <span class="menu-title">Welcome Message</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/email/reset-password.html')}}" class="menu-link ">
                        <span class="menu-title">Reset Password</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/email/subscription-confirmed.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/email/card-declined.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/email/promo-1.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/email/promo-2.html')}}" class="menu-link ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="{{asset('metronic/authentication/email/promo-3.html')}}" class="menu-link ">
...
<div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px" >
    ...
    <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/projects/list.html')}}"  >
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/projects/project.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/projects/targets.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/projects/budget.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/projects/users.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
                <span  class="menu-title" >Users</span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/projects/files.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/projects/activity.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
            </span>
            <span  class="menu-title" >Activity</span>
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/projects/settings.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
            <span  class="menu-title" >Settings</span>
...
<div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
    ...
    <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/catalog/products.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
            ...
            <div  class="menu-item" >
                <!--begin:Menu link-->
                <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/catalog/categories.html')}}"  >
                    <span  class="menu-bullet" >
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div  class="menu-item" >
                <!--begin:Menu link-->
                <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/catalog/add-product.html')}}"  >
                    <span  class="menu-bullet" >
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div  class="menu-item" >
                <!--begin:Menu link-->
                <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/catalog/edit-product.html')}}"  >
                    <span  class="menu-bullet" >
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div  class="menu-item" >
                <!--begin:Menu link-->
                <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/catalog/add-category.html')}}"  >
                    <span  class="menu-bullet" >
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div  class="menu-item" >
                <!--begin:Menu link-->
                <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/catalog/edit-category.html')}}"  >
                    <span  class="menu-bullet" >
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div  class="menu-sub menu-sub-accordion" >
        <!--begin:Menu item--><div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/sales/listing.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/sales/details.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/sales/add-order.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/sales/edit-order.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div  class="menu-sub menu-sub-accordion" >
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/customers/listing.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/customers/details.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
...
<div  class="menu-sub menu-sub-accordion" >
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/reports/view.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/reports/sales.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
            <span  class="menu-title" >Sales</span>
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/reports/returns.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/reports/customer-orders.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/reports/shipping.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
...
<div  class="menu-item" >
    <!--begin:Menu link-->
    <a class="menu-link"  href="{{asset('metronic/apps/ecommerce/settings.html')}}"  >
        <span  class="menu-bullet" >
            <span class="bullet bullet-dot"></span>
        </span>
        <span  class="menu-title" >Settings</span>
...
<div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
    ...
    <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/support-center/tickets/list.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/support-center/tickets/view.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/support-center/tutorials/list.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/support-center/tutorials/post.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
...
<div  class="menu-item" >
    <!--begin:Menu link-->
    <a class="menu-link"  href="{{asset('metronic/apps/support-center/faq.html')}}"  >
        <span  class="menu-bullet" >
            <span class="bullet bullet-dot"></span>
        </span>
...
<div  class="menu-item" >
    <!--begin:Menu link-->
    <a class="menu-link"  href="{{asset('metronic/apps/support-center/licenses.html')}}"  >
        <span  class="menu-bullet" >
            <span class="bullet bullet-dot"></span>
        </span>
        <span  class="menu-title" >Licenses</span>
...
<div  class="menu-item" >
    <!--begin:Menu link-->
    <a class="menu-link"  href="{{asset('metronic/apps/support-center/contact.html')}}"  >
        <span  class="menu-bullet" >
            <span class="bullet bullet-dot"></span>
        </span>
        <span  class="menu-title" >Contact Us</span>
...
<div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
    ...
    <div  
        ...
        <span class="menu-link"  >
            ...
            <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
                ...
                <div  class="menu-item" >
                    <!--begin:Menu link-->
                    <a class="menu-link"  href="{{asset('metronic/apps/user-management/users/list.html')}}"  >
                        <span  class="menu-bullet" >
                            <span class="bullet bullet-dot"></span>
                        </span>
                    ...
                    <div  class="menu-item" >
                        <!--begin:Menu link-->
                        <a class="menu-link"  href="{{asset('metronic/apps/user-management/users/view.html')}}"  >
                            <span  class="menu-bullet" >
                                <span class="bullet bullet-dot"></span>
                            </span>
            ...
            <span class="menu-link"  >
                ...
                <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
                    ...
                    <div  class="menu-item" >
                        <!--begin:Menu link-->
                        <a class="menu-link"  href="{{asset('metronic/apps/user-management/roles/list.html')}}"  >
                            <span  class="menu-bullet" >
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div  class="menu-item" >
                        <!--begin:Menu link-->
                        <a class="menu-link"  href="{{asset('metronic/apps/user-management/roles/view.html')}}"  >
                            <span  class="menu-bullet" >
                                <span class="bullet bullet-dot"></span>
                            </span>
            ...
            <div  class="menu-item" ><!--begin:Menu link-->
                <a class="menu-link"  href="{{asset('metronic/apps/user-management/permissions.html')}}"  >
                    <span  class="menu-bullet" >
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/contacts/getting-started.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/contacts/add-contact.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/contacts/edit-contact.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
            ...
            <div  class="menu-item" >
                <!--begin:Menu link-->
                <a class="menu-link"  href="{{asset('metronic/apps/contacts/view-contact.html')}}"  >
                    <span  class="menu-bullet" >
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/subscriptions/list.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/subscriptions/add.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div  class="menu-item" >
            <!--begin:Menu link-->
            <a class="menu-link"  href="{{asset('metronic/apps/subscriptions/view.html')}}"  >
                <span  class="menu-bullet" >
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/customers/getting-started.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
            <span  class="menu-title" >Getting Started</span>
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/customers/list.html')}}"  >
            <span  class="menu-bullet" >
                <span class="bullet bullet-dot"></span>
            </span>
    ...
    <div  class="menu-item" >
        <!--begin:Menu link-->
        <a class="menu-link"  href="{{asset('metronic/apps/customers/view.html')}}"  >
            <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
        ...
        <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
            ...
            <div  data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"  class="menu-item menu-lg-down-accordion" >
                ...
                <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
                    ...
                    <div  class="menu-item" >
                        <!--begin:Menu link-->
                        <a class="menu-link"  href="{{asset('metronic/apps/invoices/view/invoice-1.html')}}"  >
                            <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                        ...
                        <div  class="menu-item" >
                            <!--begin:Menu link-->
                            <a class="menu-link"  href="{{asset('metronic/apps/invoices/view/invoice-2.html')}}"  >
                                <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                            ...
                            <div  class="menu-item" >
                                <!--begin:Menu link-->
                                <a class="menu-link"  href="{{asset('metronic/apps/invoices/view/invoice-3.html')}}"  >
                                    <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                        ...
                        <div  class="menu-item" ><!--begin:Menu link-->
                            <a class="menu-link"  href="{{asset('metronic/apps/invoices/create.html')}}"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                        ...
                        <div  data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"  class="menu-item menu-lg-down-accordion" >
                            ...
                            <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
                                ...
                                <div  class="menu-item" >
                                    <!--begin:Menu link-->
                                    <a class="menu-link"  href="{{asset('metronic/apps/file-manager/folders.html')}}"  >
                                        <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                    ...
                                    <div  class="menu-item" >
                                        <!--begin:Menu link-->
                                        <a class="menu-link"  href="{{asset('metronic/apps/file-manager/files.html')}}"  >
                                            <span  class="menu-bullet" >
                                            ...
                                            <div  class="menu-item" >
                                                <!--begin:Menu link-->
                                                <a class="menu-link"  href="{{asset('metronic/apps/file-manager/blank.html')}}"  >
                                                    <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                                ...
                                                <div  class="menu-item" >
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link"  href="{{asset('metronic/apps/file-manager/settings.html')}}"  >
                                                        <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                            ...
                                            <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
                                                ...
                                                <div  class="menu-item" >
                                                <!--begin:Menu link-->
                                                    <a class="menu-link"  href="{{asset('metronic/apps/inbox/listing.html')}}"  >
                                                        <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                                        <span  class="menu-title" >Messages</span>
                                                        <span  class="menu-badge" ><span class="badge badge-light-success">3</span></span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                <!--end:Menu item-->
                                                ...
                                                <div  class="menu-item" >
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link"  href="{{asset('metronic/apps/inbox/compose.html')}}"  >
                                                        <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                                ...
                                                <div  class="menu-item" >
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link"  href="{{asset('metronic/apps/inbox/reply.html')}}"  >
                                                        <span  class="menu-bullet" >
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" >
                                                ...
                                                <div  class="menu-item" >
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link"  href="{{asset('metronic/apps/chat/private.html')}}"  >
                                                        <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                                    ...
                                                    <div  class="menu-item" >
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"  href="{{asset('metronic/apps/chat/group.html')}}"  >
                                                            <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                                            <span  class="menu-title" >Group Chat</span></a>
                                                            <!--end:Menu link-->
                                                        </div><!--end:Menu item--><!--begin:Menu item-->
                                                        <div  class="menu-item" ><!--begin:Menu link-->
                                                            <a class="menu-link"  href="{{asset('metronic/apps/chat/drawer.html')}}"  >
                                                                <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                                    ...
                                                    <div  class="menu-item" >
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"  href="{{asset('metronic/apps/calendar.html')}}"  >
                                                            <span  class="menu-icon" >
...
<div 
    ...
    <div class="d-flex align-items-center" data-kt-search-element="toggle" id="kt_header_search_toggle">
        <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px">
            <i class="fa-solid fa-magnifying-glass"><span class="path1"></span><span class="path2"></span></i>                    </div>
    </div>
    <!--end::Search toggle-->
...
<form data-kt-search-element="form" class="w-100 position-relative mb-3" autocomplete="off">	
    <!--begin::Icon-->
    <i class="fa-solid fa-magnifying-glass"><span class="path1"></span><span class="path2"></span></i>    <!--end::Icon-->
    ...
    <div class="position-absolute top-50 end-0 translate-middle-y" data-kt-search-element="toolbar">
        ...
        <div data-kt-search-element="preferences-show" class="btn btn-icon w-20px btn-sm btn-active-color-primary me-1" data-bs-toggle="tooltip" title="Show search preferences">
            <i class="fa-solid fa-gear"></i><span class="path1"></span><span class="path2"></span></i>        </div>
...
<!--end::Search-->    </div>
    ...
    <div class="app-navbar-item ms-1 ms-md-4">
        ...
        <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" id="kt_menu_item_wow">
            <i class="fa-solid fa-comment"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>        </div>
...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
 ...
 fs-2 text-info"></i>                                                    
			...
			<div class="py-3 text-center border-top">
                <a href="{{asset('metronic/pages/user-profile/activity.html')}}" class="btn btn-color-gray-600 btn-active-color-primary">
                    View All 
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px" data-kt-menu="true" data-kt-element="theme-mode-menu">
    ...
    <div class="menu-item px-3 my-0">
        <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light">
            <span class="menu-icon" data-kt-element="icon">
                <i class="fa-solid fa-sun"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span><span class="path7"></span><span class="path8"></span><span class="path9"></span><span class="path10"></span></i>            </span>
    ...
    <div class="menu-item px-3 my-0">
        <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="dark">
            <span class="menu-icon" data-kt-element="icon">
                <i class="fa-solid fa-moon"><span class="path1"></span><span class="path2"></span></i>            </span>
            <span class="menu-title">
                Dark theme
            </span>
        </a>
    ...
    <div class="menu-item px-3 my-0">
        <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="system">
            <span class="menu-icon" data-kt-element="icon">
                <i class="fa-solid fa-lightbulb"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>            </span>
            <span class="menu-title">
                System's theme
            </span>
        </a>
        ...
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="d-flex flex-column">
                <div class="fw-bold d-flex align-items-center fs-5">
                    {{ auth()->user()->nama }}                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>
                </div>
        ...
        <a href="#" class="menu-link px-5">
            <span class="menu-title position-relative">
                ...
                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    Inggris <img class="w-15px h-15px rounded-1 ms-2" src="{{asset('metronic/assets/media/flags/united-states.svg')}}" alt=""/>
                </span>
            </span>
        </a>
...
<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    <div  class="menu-item pt-5" >
        ...
        <div  class="menu-content" >
            <span class="menu-heading fw-bold text-uppercase fs-7">Data-data</span>
        </div>
        <!--end:Menu content-->
    </div>
    <!--end:Menu item-->
        ...
        <div  class="menu-sub menu-sub-accordion" >
            ...
            <div  class="menu-item" >
                ...
                <a class="menu-link"  href="pages/user-profile/overview.html"  >
                    <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                    <span  class="menu-title" >Lihat Data Cabang</span></a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                <!--begin:Menu item-->
                <div  class="menu-item" >
                    ...
                    <a class="menu-link"  href="pages/user-profile/projects.html"  >
                        <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                        <span  class="menu-title" >Tambah Data Cabang</span></a>
                        <!--end:Menu link-->
                </div>
            </div>
            <!--end:Menu item-->
            <div  data-kt-menu-trigger="click"  class="menu-item menu-accordion" >
                ...
                <div  class="menu-sub menu-sub-accordion" >
                    ...
                    <div  class="menu-item" >
                        ...
                        <a class="menu-link"  href="pages/user-profile/overview.html"  >
                            <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                            <span  class="menu-title" >Lihat Data Karir Karyawan</span></a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        <!--begin:Menu item-->
                        <div  class="menu-item" >
                            ...
                            <a class="menu-link"  href="pages/user-profile/projects.html"  >
                                <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                <span  class="menu-title" >Tambah Data Karir</span></a>
                                <!--end:Menu link-->
                        </div>
                    </div>
            <!--begin:Menu item-->
                    ...
                    <!--begin:Menu link-->
                        <span class="menu-link"  >
                            ...
                            <span  class="menu-title" >Layanan (TBA)</span>
                            <span  class="menu-arrow" ></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                            ...
                            <!--begin:Menu item-->
                                <div  class="menu-item" >
                                    ...
                                    <a class="menu-link"  href="account/overview.html"  >
                                        <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                        <span  class="menu-title" >Lihat Layanan</span></a>
                                    <!--end:Menu link-->
                                </div>
                                    <!--end:Menu item-->
                                    <!--begin:Menu item-->
                                <div  class="menu-item" >
                                        ...
                                        <a class="menu-link"  href="account/settings.html"  >
                                            <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                            <span  class="menu-title" >Tambah Layanan</span></a>
                                            <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    <!--end:Menu sub-->
                                        ...
                                        <div  data-kt-menu-trigger="click"  class="menu-item menu-accordion" >
                                            ...
                                            <div  class="menu-item" >
                                                ...
                                                <a class="menu-link"  href="authentication/extended/multi-steps-sign-up.html"  >
                                                    <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                                    <span  class="menu-title" >Gambaran Umum Perusahaan</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                            ...
                                            <div  class="menu-item" >
                                                ...
                                                <a class="menu-link"  href="authentication/general/welcome.html"  >
                                                    <span  class="menu-bullet" >
                                                        <span class="bullet bullet-dot"></span></span>
                                                        <span  class="menu-title" >Visi Perusahaan</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                            ...
                                            <!--begin:Menu link-->
                                                <a class="menu-link"  href="authentication/general/verify-email.html"  >
                                                    <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                                    <span  class="menu-title" >Misi Perusahaan</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                            ...
                                            <div  class="menu-item" >
                                                ...
                                                <a class="menu-link"  href="authentication/general/coming-soon.html"  >
                                                    <span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span>
                                                    <span  class="menu-title" >Keunggulan Perusahaan</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
